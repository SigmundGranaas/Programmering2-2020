...
import oblig5.A.controllers.*;
import oblig5.A.model.*;
...
public class ContactsApp extends Application {
  ...
  private AdressBookDBHandler aBDBH;
  ...
  public void init() throws Exception {
    ...
    this.addressBookPlain = (AddressBookPlain) this.mainController.loadAddressBookFromFile();
    this.aBDBH = new AdressBookDBHandler();
  }
  ...
  public void start(Stage primaryStage) {
    ...
    MenuBar mainMenu = null;  //Creates our main menu to hold our Sub-Menus.
    mainMenu = createMenus();
    ToolBar toolBar = null;  // Creates a toolbar below the menubar
  ...
  public void updateObservableList() {
    this.addressBookListWrapper.setAll(this.aBDBH.getAllContacts());
  }
  ...
  private ObservableList<ContactDetails> getAddressBookListWrapper() {
    ...
    addressBookListWrapper
      = FXCollections.observableArrayList(this.aBDBH.getAllContacts());
  ...
  private ToolBar createToolBar() {
    ...
    addContactBtn.setOnAction(actionEvent -> mainController.addContact(this.aBDBH, this));
  ...
  private MenuBar createMenus() {
    ...
    addContactMenu.setOnAction(event -> mainController.addContact(this.addressBookPlain, this));
    ...
    removeContactMenu.setOnAction(event -> mainController.deleteContact(
        this.contactDetailsTableView.getSelectionModel()
          .getSelectedItem(), this.addressBookPlain, this));
